...
function Nav({ inputRef, handleCreateNewList, enterEditListNameMode }) {
...
//   const [showTopNav, setShowTopNav] = useState(false)
  ...
  return (
    ...
    <>
    <div className="nav fixed top-0 left-0 w-full py-2">

      <div className='flex justify-center'>
      
      <Link
      to='/Quik-List'
      className="nav-button mx-12 p-2  rounded-2xl ">
        <AiFillHome size={30} />
      </Link>
      ...
      <Link onClick={toggleDarkMode} className="nav-button mx-12 p-2   rounded-2xl">
